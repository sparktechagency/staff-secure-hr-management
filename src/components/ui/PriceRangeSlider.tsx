      ...
      <div className="relative">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="absolute w-full h-1.5 top-[-6px] bg-transparent pointer-events-none appearance-none [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[#0c3188] [&::-webkit-slider-thumb]:pointer-events-auto"
          />
          <input
            type="range"
            name="maxRange"
